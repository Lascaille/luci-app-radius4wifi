...
load: function() {
  ...
  render: function(certs) {
    ...
    resetBtn.onclick = function() {
      var el1 = document.getElementById(chk1.cbid(chk1.section));
      var el2 = document.getElementById(chk2.cbid(chk2.section));

      var is1Checked = el1 && el1.checked;
      var is2Checked = el2 && el2.checked;
